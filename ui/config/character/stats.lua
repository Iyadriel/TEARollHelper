    ...
    return {
        ...
        args = {
            offence = {
                ...
                desc = "Proficiency bonus: +1 base damage. |nMastery bonus: +2 base damage. You have the Feat 'Focus' without it occupying your Feat slot (works even with Featless).",
                min = STAT_MIN_VALUE,
                max = STAT_MAX_VALUE,
                step = 1,
                order = 0
            ...
            spirit = {
                ...
                desc = "Proficiency bonus: +1 Greater Heal slot, healing done increased by +1. |nMastery bonus: +1 Greater Heal slot, healing done increased by +2. Increases to +4 against KO'd targets.",
                min = STAT_MIN_VALUE,
                max = STAT_MAX_VALUE,
                step = 1,
                order = 2
