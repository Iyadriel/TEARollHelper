...
local RACIAL_TRAITS = {
    ...
    MIGHT_OF_THE_MOUNTAIN = { id = 3, desc = DESCRIPTIONS.MIGHT_OF_THE_MOUNTAIN, name = "Might of the Mountain", supported = false, manualActivation = false },
    ...
    DUNGEON_DELVER = { id = 34, desc = DESCRIPTIONS.DUNGEON_DELVER, name = "Dungeon Delver", supported = false, manualActivation = false },
