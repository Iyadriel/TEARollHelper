...
local FEATS = {
    ...
    ETERNAL_SACRIFICE = {
        ...
        desc = "Your melee attacks have advantage.|nYour Defence is increased by +4 against magical attacks.|nYou unlock the following traits: Blade Dance, Fel Rush.|nYou gain the following weaknesses: Corrupted, Fateless, Reckless Abandon, Old Scars, Outcast.",
        passives = {
            resistance = {
